...
public class MovieListFragment extends ListFragment {
    ...
    public ArrayList<Movie> mMovieData = new ArrayList<Movie>();
    ...
    public void onCreate(Bundle savedInstanceState) {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                Movie movie = new Movie(new ArrayList<String>(), movieJson.getDouble("rating"),
        ...
        mAdapter = new MovieListAdapter(mMovieData, getActivity(), Singleton.imageLoader);
    ...
    private void setActivatedPosition(int position) {
        if (position == ListView.INVALID_POSITION) {
            mMovieData.get(mActivatedPosition).setIsActive(false);
        } else {
            getListView().setItemChecked(position, true);
            mMovieData.get(position).setIsActive(true);
        }
